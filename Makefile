...
mkdocs : 
	...
	-$(BOOKDOWN2MKDOCS) convert --site-name=phly-mustache --repo-url=https://github.com/phly/phly-mustache --copyright-url=https://mwop.net/ --copyright-author="Matthew Weier O\'Phinney"
